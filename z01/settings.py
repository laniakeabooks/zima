"""
Django settings for z01 project.
...
SECRET_KEY = "django-insecure-sia0kvt$k(r#+)o0t-v5(!olg8$hdgvvhhqrjq9bl)e^3quh3&"
...
WSGI_APPLICATION = "z01.wsgi.application"
